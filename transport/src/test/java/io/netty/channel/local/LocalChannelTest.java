            ...
            try {
                ...
                cc.pipeline().lastContext().executor().execute(new OneTimeTask() {
                    ...
                    public void run() {
                        ...
                        ccCpy.writeAndFlush(data.duplicateRetained(), promise);
                    }
                });
                ...
                cc.pipeline().lastContext().executor().execute(new OneTimeTask() {
                    ...
                    public void run() {
                        ...
                        promise.addListener(new ChannelFutureListener() {
                            @Override
                            public void operationComplete(ChannelFuture future) throws Exception {
                                ccCpy.writeAndFlush(data2.duplicateRetained(), ccCpy.newPromise());
                            }
                        });
                        ccCpy.writeAndFlush(data.duplicateRetained(), promise);
                    }
                ...
                public void run() {
                    ...
                    promise.addListener(new ChannelFutureListener() {
                        ...
                        public void operationComplete(ChannelFuture future) throws Exception {
                            ...
                            serverChannelCpy.writeAndFlush(data2.duplicateRetained(), serverChannelCpy.newPromise());
                        }
                    });
                    ccCpy.writeAndFlush(data.duplicateRetained(), promise);
                }
                        ...
                        promise.addListener(new ChannelFutureListener() {
                            ...
                            public void operationComplete(ChannelFuture future) throws Exception {
                                ...
                                serverChannelCpy.writeAndFlush(
                                        data2.duplicateRetained(), serverChannelCpy.newPromise());
                            }
                        });
                        ccCpy.writeAndFlush(data.duplicateRetained(), promise);
                    }
        ...
        try {
            ...
            try {
                ...
                cc.pipeline().lastContext().executor().execute(new OneTimeTask() {
                    @Override
                    public void run() {
                        ccCpy.writeAndFlush(data.duplicateRetained(), ccCpy.newPromise())
                            ...
                            public void operationComplete(ChannelFuture future) throws Exception {
                                serverChannelCpy.eventLoop().execute(new OneTimeTask() {
                                    ...
                                    public void run() {
                                        ...
                                        serverChannelCpy.writeAndFlush(data2.duplicateRetained(),
