        ...
        switch (state) {
            ...
            case READ_EXTRAS: try {
                ...
                if (extrasLength > 0) {
                    ...
                    currentMessage.setExtras(in.readSliceRetained(extrasLength));
                }
            ...
            case READ_KEY: try {
                ...
                if (keyLength > 0) {
                    ...
                    currentMessage.setKey(in.readSliceRetained(keyLength));
                }
            ...
            case READ_CONTENT: try {
                ...
                if (valueLength > 0) {
                    ...
                    ByteBuf chunkBuffer = in.readSliceRetained(toRead);
