        ...
        try {
            ...
            runInChannel(clientChannel, new Http2Runnable() {
                ...
                public void run() {
                    ...
                    clientHandler.encoder().writeData(ctxClient(), 3, content.duplicateRetained(), 0, true,
                                                      newPromiseClient());
                    clientChannel.flush();
                }
            });
            ...
            runInChannel(clientChannel, new Http2Runnable() {
                ...
                public void run() {
                    ...
                    clientHandler.encoder().writeData(
                            ctxClient(), 3, content.sliceRetained(0, midPoint), 0, false, newPromiseClient());
                    clientHandler.encoder().writeData(
                            ctxClient(), 3, content.sliceRetained(midPoint, text.length() - midPoint),
    ...
    public void clientRequestTrailingHeaders() throws Exception {
        ...
        try {
            ...
            runInChannel(clientChannel, new Http2Runnable() {
                ...
                public void run() {
                    clientHandler.encoder().writeHeaders(ctxClient(), 3, http2Headers, 0, false, newPromiseClient());
                    clientHandler.encoder().writeData(ctxClient(), 3, content.duplicateRetained(), 0, false,
                                                      newPromiseClient());
        ...
        try {
            ...
            runInChannel(clientChannel, new Http2Runnable() {
                ...
                public void run() {
                    ...
                    clientHandler.encoder().writeData(ctxClient(), 3, content.duplicateRetained(), 0, true,
                                                      newPromiseClient());
                    clientHandler.encoder().writeData(ctxClient(), 5, content2.duplicateRetained(), 0, true,
                                                      newPromiseClient());
                    clientChannel.flush();
                }
            });
        ...
        try {
            ...
            runInChannel(serverConnectedChannel, new Http2Runnable() {
                ...
                public void run() {
                    ...
                    serverHandler.encoder().writeData(ctxServer(), 3, content.duplicateRetained(), 0, true,
                                                      newPromiseServer());
                    serverHandler.encoder().writeData(ctxServer(), 5, content2.duplicateRetained(), 0, true,
                                                      newPromiseServer());
    ...
    public void serverResponseHeaderInformational() throws Exception {
        ...
        try {
            ...
            runInChannel(clientChannel, new Http2Runnable() {
                @Override
                public void run() {
                    clientHandler.encoder().writeData(ctxClient(), 3, payload.duplicateRetained(), 0, true,
                                                      newPromiseClient());
                    clientChannel.flush();
                }
            });
